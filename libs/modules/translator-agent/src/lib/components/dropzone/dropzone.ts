...
import { DocUpload } from '../../models/translator.models';

/** Single-file dropzone for the translate flow — accepts PDF/JPG/PNG, uploaded in chunks. */
@Component({
    selector: 'lib-translator-dropzone',
    standalone: true,
    imports: [CommonModule, TranslateModule, ButtonModule, ProgressBarModule],
    templateUrl: './dropzone.html',
})
export class TranslatorDropzoneComponent {
