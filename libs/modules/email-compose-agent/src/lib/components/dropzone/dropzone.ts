...
import { EmailUpload } from '../../models/email-compose-agent.models';

/** Single-file dropzone for the reply-thread upload flow — accepts PDF/DOCX/TXT, uploaded in chunks. */
@Component({
    selector: 'lib-email-compose-dropzone',
    standalone: true,
    imports: [CommonModule, TranslateModule, ButtonModule, ProgressBarModule],
    templateUrl: './dropzone.html',
})
export class EmailComposeDropzoneComponent {
    @Input() doc: EmailUpload | null = null;
